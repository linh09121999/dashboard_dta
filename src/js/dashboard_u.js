...
const optionMenu = document.querySelector(".select-menu"),
    ...
    sBtn_text = optionMenu.querySelector("#sBtn-text-u");
...
document.getElementById("div-select-u").addEventListener('click', function () {
    $(".custom-model-main-u").addClass('model-open-u');
});

document.getElementById("close-btn-u").addEventListener('click', function () {
    $(".custom-model-main-u").removeClass('model-open-u');
});

document.getElementById("cancel-select-u").addEventListener('click', function () {
    $(".custom-model-main-u").removeClass('model-open-u');
});


document.getElementById("save-select-u").addEventListener('click', function () {
...
// var ctx3 = document.getElementById("chart-doughnut-3").getContext('2d');
// var gradienteID = ctx3.createLinearGradient(0, 0, 0, 300);
// gradienteID.addColorStop(0, 'rgb(33, 212, 253)');
// gradienteID.addColorStop(0.3, 'rgb(33, 82, 255)');

// var gradientSDK_L_M = ctx3.createLinearGradient(0, 0, 0, 300);
// gradientSDK_L_M.addColorStop(1, 'rgb(152, 236, 45)');
// gradientSDK_L_M.addColorStop(1, 'rgb(23, 173, 55)');

// var gradientSDK_M = ctx3.createLinearGradient(0, 0, 0, 300);
// gradientSDK_M.addColorStop(0, 'rgb(251, 207, 51)');
// gradientSDK_M.addColorStop(0.3, 'rgb(245, 57, 57)');

// var gradientFace_R = ctx3.createLinearGradient(0, 0, 0, 300);
// gradientFace_R.addColorStop(0, 'rgb(255, 0, 128)');
// gradientFace_R.addColorStop(0.3, 'rgb(121, 40, 202)');
// var myChartDoughnut3 = new Chart(ctx3, {
//     type: 'doughnut',
//     data: {
//         labels: ["DỊCH VỤ EID", "DỊCH VỤ SDK-LIVENESS-MATCH", "DỊCH VỤ SDK-MATCH", "DỊCH VỤ FACE-RECOG"],
//         datasets: [{
//             backgroundColor: [
//                 gradienteID,
//                 gradientSDK_L_M,
