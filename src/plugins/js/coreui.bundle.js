...
(function (global, factory) {
  ...
  const getDateBySelectionType = (date, selectionType) => {
    ...
    if (selectionType === 'month') {
      const monthNumber = `${date.getMonth() + 1}`.slice(-2);
  ...
  */
  ...
  const Default$i = {
    ...
    confirmButtonClasses: ['btn', 'btn-sm', 'btn-ok'],
    container: false,
    disabled: false,
    footer: true,
    hours: null,
  ...
  const Default$h = {
    ...
    calendars: 2,
    cancelButton: 'Hủy bỏ',
    cancelButtonClasses: ['btn', 'btn-sm', 'btn-cancel'],
    confirmButton: 'Đồng ý',
    confirmButtonClasses: ['btn', 'btn-sm', 'btn-ok'],
    cleaner: true,
    container: false,
    ...
    range: true,
    ranges: {},
    rangesButtonsClasses: ['btn', 'btn-secondary'],
    required: true,
    separator: true,
    size: null,
    startDate: null,
    ...
    timepicker: false,
    todayButton: 'Hôm nay',
    todayButtonClasses: ['btn', 'btn-sm', 'btn-ok', 'me-auto'],
    valid: false,
    weekdayFormat: 2,
    weekNumbersLabel: null
  };
  ...
  const Default$a = {
    ...
    selectionType: 'tags',
    selectionTypeCounterText: 'Được chọn',
    valid: false
  };
  const DefaultType$a = {
